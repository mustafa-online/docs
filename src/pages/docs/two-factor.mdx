...
description: Secure your account with two-step authentication
---
...
From your administrator interface, click on your name and account picture in the upper right corner. Next click on **Personal Account** menu

<img className="shadow-lg rounded-lg" src="/img/profile-dropdown.png" alt="Profile Picture Screenshot" />
...
<img className="shadow-lg rounded-lg" src="/img/two-factor-section.png" alt="Two factor section Screenshot" />
...
<img className="shadow-lg rounded-lg" src="/img/two-factor-code.png" alt="Two factor code Screenshot" />
...
<img className="shadow-lg rounded-lg" src="/img/two-factor-login.png" alt="Two factor code Screenshot" />
...
<img className="shadow-lg rounded-lg" src="/img/two-factor-disable.png" alt="Two factor disable Screenshot" />