...
Shopper is realy easy to install. After creating your new Laravel application \(8+\) you can include the Shopper package with the following command:
...
## <Heading number="4">Update Existing Files</Heading>
...
## <Heading number="5">Create an Admin user</Heading>
...
## <Heading number="6">Publish Vendor Files</Heading>
